...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-theme="light">
    <head>
        ...
        <title><?php if (! empty(trim($__env->yieldContent('title')))): ?> <?php echo $__env->yieldContent('title'); ?> - <?php endif; ?> <?php echo e(config('app.name', 'Старый кот')); ?></title>
    ...
    <body class="font-golos-text antialiased text-gray-800">
        <div class="bg-[#f8f7fa]">
            ...
            <div class="flex min-h-screen">
                <div id="_sidebar" class="bg-[#2f3349] text-[#cfcce4] group <?php echo e(cache('sidebar') === 1 ? 'min-w-64 open' : 'w-16 close'); ?>">
